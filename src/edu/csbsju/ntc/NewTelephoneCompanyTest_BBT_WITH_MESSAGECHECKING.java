...
public class NewTelephoneCompanyTest_BBT_WITH_MESSAGECHECKING {
  //@Rule
  ...
  @Test
  public void testComputeCharge_InvalidStartTimeUSINGRULE() {
    expectedEx.expect(UnsupportedOperationException.class);
    expectedEx.expectMessage("Invalid START TIME");
    ntc.setStartTime(1160);
    ntc.setDuration(40);
    ntc.computeCharge();
  }
  ...
  @Test
  public void testComputeCharge_InvalidDurationUSINGRULE() {
    expectedEx.expect(UnsupportedOperationException.class);
    expectedEx.expectMessage("Invalid LENGTH");
    ntc.setStartTime(1144);
    ntc.setDuration(-1);
    ntc.computeCharge();
  } 
